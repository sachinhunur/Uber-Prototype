...
amqp
    .connect(
        ...
        function(err, conn) {
	      ...
	      // l = Math.floor(Math.random() * (37747 - 37132 + 1)) + 37132;
	      // lat = l / 1000;
	      // ln = Math.floor(Math.random() * (122498 - 121514 + 1)) + 121514;
	      // lng = 0 - ln / 1000;
	      // console.log(lng, " " + lat);
	      ...
	      pool
	          .getConnection(function(err, connection) {
	            for (var i = 0; i < 60000; i++) {
		          var sql = "INSERT into bill(start_time,end_time,distance,price,origin,destination,date,customer_id,driver_id) VALUES('"
		              + "13:57:42" + "','" + "14:21:02" + "','" + chance.integer({
		                min : 15,
		                max : 150
		              }) + "','" + chance.floating({
		                min : 10,
		                max : 200,
		                fixed : 2
		              }) + "','" + chance.address() + "','" + chance.address() + "','" + chance.date({
		                string : true
		              }) + "','" + chance.integer({
		                min : 30,
		                max : 100000
